# INSERT INTO playlists (name, channels) VALUES ('chizhov', "['Первый канал', 'Россия 1', 'МАТЧ!', 'НТВ', 'Пятый канал',
# 'Россия К', 'ТВ Центр', 'КАРУСЕЛЬ', 'Россия 24', 'ОТР', 'РЕН ТВ', 'Спас', 'СТС', 'Домашний', 'ТВ-3', 'Пятница',
# 'Звезда', 'Мир', 'ТНТ', 'МУЗ ТВ']")
